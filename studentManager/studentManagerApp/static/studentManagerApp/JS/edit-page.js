document.addEventListener('DOMContentLoaded', function () {
    ...
    formulaire.addEventListener('submit', function (event) {
        ...
        if (types_modification.value === "par_matiere") {
            enregistrerNotes();
        } else {
            enregistrerNotesEtudiant();
        }
    });
    ...
    function afficherModifications() {
        ...
        if (type_modification == "par_matiere") {
            ...
            if (studentArray.length == 0) {
                ...
                notesParEtudiants.id = "notesParEtudiants";
    ...
    function enregistrerNotesEtudiant() {
        const notesParEtudiants = document.getElementById("notesParEtudiants");
